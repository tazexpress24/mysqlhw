...
ALTER TABLE actor ADD COLUMN description blob(45) NULL AFTER first_name;
...
-- 5a. You cannot locate the schema of the address table. Which query would you use to re-create it?
 ...
 ON staff.address_id = address.address_id INNER JOIN city ON address.city_id = city.city_id 
